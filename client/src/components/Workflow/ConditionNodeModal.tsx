...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, Stack, Box, Typography, Tooltip, IconButton } from '@mui/material';
...
const ConditionNodeModal: React.FC<ConditionNodeModalProps> = ({ node, isOpen, onRequestClose, onSave }) => {
  ...
  return (
    <Dialog open={isOpen} onClose={onRequestClose} maxWidth="sm" fullWidth>
      <DialogTitle>Condition Node Configuration</DialogTitle>
